    ...
    return (
        <div className="navbar">
            <div className="leftAlignment homeLogo">
                ...
                <div><h1>Menteez</h1></div>
                
                
            </div>
            <div className="rightAlignment nav">
                <div className="navText"><a href="/guide">Guide</a></div>
                <div id="google_translate_element"></div>
                <div className="navText"><a href="/main">Logout</a></div>
    ...
    return (
        <div className="banner">
            <div>
                ...
                <button><a href="#appointment">Book a demo</a></button>
            </div>
        ...
        <div className="drVariety" id="appointment">
            ...
            <div className="ngoVariety">
                <div className="dr1">
                    ...
                    <b><p><Link to="/doctor1">Dr. Iqra Khan</Link></p></b>
                </div>
                <div className="dr1">
                    <img className="drImg" src={dr2} alt="ngo1" height="350px" width="250px" />
                    <b><p><Link to="/doctor2">Dr. Kamal Singh</Link></p></b>
                </div>
                <div className="dr1">
                    <img className="drImg" src={dr3} alt="ngo1" height="350px" width="250px" />
                    <b><p><Link to="/doctor3">Dr. Shyeya</Link></p></b>
                </div>
            </div>
        </div>
    )
