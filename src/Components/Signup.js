        ...
        <Components.Container>
            <Components.SignInContainer signingIn={signUp}>
                <Components.Form action="POST">
                    ...
                    <Components.Input id="name"type="text" placeholder="Name" onChange={(e) => { setName(e.target.value) }} />
                    ...
                    <Components.Anchor href='/signupd'>Sign Up As A Doctor</Components.Anchor>
